...
var InfiniteScroll = function (_Component) {
  ...
  _createClass(InfiniteScroll, [{
    ...
    value: function scrollListener() {
      var el = this.props.scrollElementSelector ? document.querySelector(this.props.scrollElementSelector).children[0] : this.scrollComponent;
      var scrollEl = window;
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['children', 'element', 'hasMore', 'initialLoad', 'isReverse', 'loader', 'loadMore', 'pageStart', 'ref', 'threshold', 'useCapture', 'useWindow', 'scrollElementSelector']);
